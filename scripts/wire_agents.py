...
def discover_agents(actors_dir: Path | None = None) -> list[dict[str, Any]]:
    """
...
def get_agent_metadata(agent_type: str, actors_dir: Path | None = None) -> dict[str, Any] | None:
    """
...
def export_agent_config(agent_type: str, output_path: Path | None = None) -> Path | None:
    """
...
if __name__ == "__main__":
    ...
    for _agent in agents[:5]:  # Show first 5
        pass
