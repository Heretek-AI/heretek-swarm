...
from heretek_swarm.config.providers import AVAILABLE_PROVIDERS
from heretek_swarm.config.service import (
    ConfigurationService,
    get_config_service,
)
from heretek_swarm.config.tiers import AGENT_TIERS
...
# =============================================================================
# (Catalog moved to heretek_swarm.config.providers and
# heretek_swarm.config.tiers in Phase 2.4 of PLAN.md — configuration
# service masquerading as a router. The wizard router imports the
# canonical constants at the top of this module and re-exports them
# at this module's namespace for backwards compatibility.)
__all__ = ["AVAILABLE_PROVIDERS", "AGENT_TIERS", "router"]


# (Catalog body removed; see heretek_swarm.config.providers and
# heretek_swarm.config.tiers for the canonical definitions.)
