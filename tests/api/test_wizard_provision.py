...
Tests the /api/wizard/provision endpoints including:
- Service provisioning (POST)
- Provision status (GET)
- Stop infrastructure (POST)
...
# Suppress unraisable exception warnings in tests - NATS mock cleanup is expected
