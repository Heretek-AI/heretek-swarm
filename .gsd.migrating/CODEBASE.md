...
Generated: 2026-05-10T16:30:53Z | Files: 500 | Described: 0/500
<!-- gsd:codebase-meta {"generatedAt":"2026-05-10T16:30:53Z","fingerprint":"5ab171322f2ff25393f5ad6a6bdc8219313462c9","fileCount":500,"truncated":true} -->
Note: Truncated to first 500 files. Run with higher --max-files to include all.

### (root)/
- *(25 files: 12 .0, 7 .md, 4 (no ext), 1 .example, 1 .yaml)*
...
- `.gsd.migrating/completed-units-M002.json`
...
- `.gsd.migrating/milestones/M001/slices/S01/ACTOR_AUDIT.md`
...
- `.gsd.migrating/milestones/M002/slices/S02/S02-CONTINUE.md`
...
- `.gsd.migrating/milestones/M003/slices/S02/tasks/T02-VERIFY.json`
...
- `.gsd.migrating/milestones/M006/M006-SUMMARY.md`

### .gsd.migrating/milestones/M006/slices/S01/
- `.gsd.migrating/milestones/M006/slices/S01/S01-PLAN.md`

### .gsd.migrating/milestones/M007/
- `.gsd.migrating/milestones/M007/M007-ROADMAP.md`
- `.gsd.migrating/milestones/M007/M007-SUMMARY.md`

### .gsd.migrating/milestones/M007/slices/S01/
- `.gsd.migrating/milestones/M007/slices/S01/S01-PLAN.md`

### .gsd.migrating/milestones/M007/slices/S02/
- `.gsd.migrating/milestones/M007/slices/S02/S02-PLAN.md`

### .gsd.migrating/milestones/M007/slices/S03/
- `.gsd.migrating/milestones/M007/slices/S03/S03-PLAN.md`
...
- `.gsd.migrating/reports/M001-2026-05-07T12-44-17.html`
- `.gsd.migrating/reports/M002-2026-05-07T19-04-52.html`
...
- `.gsd.migrating/safety/evidence-M001-S02-T01.json`
- `.gsd.migrating/safety/evidence-M001-S02-T02.json`
- `.gsd.migrating/safety/evidence-M002-S02-T01.json`
- `.gsd.migrating/safety/evidence-M002-S02-T02.json`
- `.gsd.migrating/safety/evidence-M002-S02-T03.json`
- `.gsd.migrating/safety/evidence-M002-S02-T04.json`
- `.gsd.migrating/safety/evidence-M002-S03-T02.json`
- `.gsd.migrating/safety/evidence-M002-S03-T03.json`
- `.gsd.migrating/safety/evidence-M003-S03-T01.json`
