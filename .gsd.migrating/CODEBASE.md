...
Generated: 2026-05-10T01:46:47Z | Files: 500 | Described: 0/500
<!-- gsd:codebase-meta {"generatedAt":"2026-05-10T01:46:47Z","fingerprint":"90291362b16827462069c48ccb29e0dca7f8a0f2","fileCount":500,"truncated":true} -->
...
### agent_workspace/agents/alpha-brain/
- `agent_workspace/agents/alpha-brain/MEMORY.md`

### agent_workspace/agents/beta/
- `agent_workspace/agents/beta/MEMORY.md`

### agent_workspace/agents/gamma/
- `agent_workspace/agents/gamma/MEMORY.md`

### agent_workspace/agents/test/
- `agent_workspace/agents/test/MEMORY.md`

### agent_workspace/agents/test_agent/
- `agent_workspace/agents/test_agent/MEMORY.md`

### agent_workspace/agents/test_fail_agent/
- `agent_workspace/agents/test_fail_agent/MEMORY.md`

### agent_workspace/agents/test_none_agent/
- `agent_workspace/agents/test_none_agent/MEMORY.md`

### agent_workspace/agents/test_weather_agent/
- `agent_workspace/agents/test_weather_agent/MEMORY.md`
...
- `heretek-swarm/LICENSE`

### heretek-swarm/agent_workspace/
- `heretek-swarm/agent_workspace/error.txt`

### heretek-swarm/agent_workspace/agents/alpha/
- `heretek-swarm/agent_workspace/agents/alpha/MEMORY.md`

### heretek-swarm/agent_workspace/agents/beta/
- `heretek-swarm/agent_workspace/agents/beta/MEMORY.md`

### heretek-swarm/agent_workspace/agents/test_agent/
- `heretek-swarm/agent_workspace/agents/test_agent/MEMORY.md`

### heretek-swarm/agent_workspace/agents/test_fail_agent/
- `heretek-swarm/agent_workspace/agents/test_fail_agent/MEMORY.md`

### heretek-swarm/agent_workspace/agents/test_none_agent/
- `heretek-swarm/agent_workspace/agents/test_none_agent/MEMORY.md`

### heretek-swarm/agent_workspace/agents/test_weather_agent/
- `heretek-swarm/agent_workspace/agents/test_weather_agent/MEMORY.md`
...
- `heretek-swarm/heretek_swarm/agents/agent_factory.py`
...
- `heretek-swarm/heretek_swarm/cli/__main__.py`
- `heretek-swarm/heretek_swarm/cli/config_loader.py`
- `heretek-swarm/heretek_swarm/cli/config_wizard.py`
- `heretek-swarm/heretek_swarm/cli/goal_commands.py`
...
- `heretek-swarm/heretek_swarm/consensus/complexity.py`
- `heretek-swarm/heretek_swarm/consensus/cons01_dispute_resolution.py`
- `heretek-swarm/heretek_swarm/consensus/consensus_coordinator.py`
- `heretek-swarm/heretek_swarm/consensus/deliberation.py`
- `heretek-swarm/heretek_swarm/consensus/domain_selector.py`
...
### heretek-swarm/heretek_swarm/goals/
- `heretek-swarm/heretek_swarm/goals/__init__.py`
- `heretek-swarm/heretek_swarm/goals/consensus.py`
- `heretek-swarm/heretek_swarm/goals/models.py`
- `heretek-swarm/heretek_swarm/goals/pipeline.py`
- `heretek-swarm/heretek_swarm/goals/proposer.py`
- `heretek-swarm/heretek_swarm/goals/store.py`
- `heretek-swarm/heretek_swarm/goals/translator.py`
...
- `heretek-swarm/heretek_swarm/mcp/agent_tools.py`
- `heretek-swarm/heretek_swarm/mcp/bridge.py`
...
- `heretek-swarm/heretek_swarm/runtime/daemon.py`
...
- `heretek-swarm/heretek_swarm/workflow/store.py`
