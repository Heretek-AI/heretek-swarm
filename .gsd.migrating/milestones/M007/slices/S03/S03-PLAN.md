...
- [x] **T01: Delete stale artifacts from pre-rename state** `est:15m`
...
- [x] **T02: Consolidate inner backend/tests/ into root tests/** `est:15m`
...
- [x] **T03: Run full integration verification suite** `est:30m`
