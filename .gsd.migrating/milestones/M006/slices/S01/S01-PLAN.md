...
- [x] **T01: Produce complete file inventory** `est:45m`
...
- [x] **T02: Map import dependencies between packages** `est:1h`
...
- [x] **T03: Audit CI, deployment, and build configuration** `est:45m`
...
- [x] **T04: Write actionable migration plan (M006-PLAN.md)** `est:1h 30m`
