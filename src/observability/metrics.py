...
class SwarmMetricsCollector:
    ...
    def __init__(
        self,
        phi_calculator: Any | None = None,
        fep_calculator: Any | None = None,
    ):
        """
    ...
    def update_agent_state(self, agent_id: str, state: str) -> None:
        ...
        self._agent_metrics[agent_id].last_activity = datetime.now(UTC).isoformat()
    ...
    def record_agent_task(
        ...
        metrics.last_activity = datetime.now(UTC).isoformat()
...
class RealTimeMetricsStream:
    ...
    def __init__(self, collector: SwarmMetricsCollector):
        ...
        self._last_prometheus_update: datetime | None = None
    ...
    def _update_prometheus_cache(self) -> None:
        ...
        self._last_prometheus_update = datetime.now(UTC)
