...
def merge_workflow_states(current: WorkflowState, update: WorkflowState) -> WorkflowState:
    """
...
class WorkflowEngine:
    ...
    def __init__(self, cycle_detector: Optional[WorkflowCycleDetector], max_iterations: int, timeout_seconds: float):
        """
    ...
    async def execute_workflow(self, workflow_id: str, _input_data: Optional[Dict[str, Any]]) -> WorkflowResult:
        """
    ...
    async def _execute_node(self, workflow: Workflow, node_id: str, context: WorkflowContext) -> None:
        """
    ...
    def _should_execute_node(self, workflow: Workflow, node: WorkflowNode, context: WorkflowContext) -> bool:
        """
    ...
    def _get_node_input(self, _workflow: Workflow, node: WorkflowNode, context: WorkflowContext) -> Dict[str, Any]:
        """
    ...
    async def _execute_agent_node(self, node: WorkflowNode, input_data: Dict[str, Any], _context: WorkflowContext) -> Any:
        """
    ...
    async def _execute_tool_node(self, node: WorkflowNode, input_data: Dict[str, Any], _context: WorkflowContext) -> Any:
        """
        Execute a tool node.
    ...
    async def _execute_chain_node(self, node: WorkflowNode, input_data: Dict[str, Any], context: WorkflowContext) -> Any:
        """
    ...
    async def _execute_memory_node(self, node: WorkflowNode, input_data: Dict[str, Any], context: WorkflowContext) -> Any:
        """
...
async def get_workflow_engine(cycle_detector: Optional[WorkflowCycleDetector], max_iterations: int, timeout_seconds: float) -> WorkflowEngine:
    """
