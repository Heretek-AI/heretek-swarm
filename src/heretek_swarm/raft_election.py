...
class RaftElection:
    ...
    async def request_vote(self, request: RequestVoteRequest) -> RequestVoteResponse:
        """
...
class MAKERConsensusWithRaft:
    ...
    async def run_consensus(self, consensus_id: str, agents: List[str], decision_func: callable, timeout: float) -> Any:
        """
