...
class MAKERConsensus:
    ...
    def __init__(self, ahead_by_k: int, min_votes: int, confidence_threshold: float, reputation_weights: Optional[Dict[str, float]]) -> None:
        """
    ...
    def _first_to_ahead_by_k(self, consensus_id: str, votes: List[Tuple[str, float]], red_flags: List[str]) -> Optional[ConsensusResult]:
        """
        First-to-ahead-by-k voting mechanism.
    ...
    def _apply_reputation_weights(self, votes: List[Vote]) -> List[Tuple[str, float]]:
        """
    ...
    def _apply_enhanced_vote_weights(self, votes: List[Vote], _consensus_id: str) -> List[Tuple[str, float]]:
        """
    ...
    def update_reputation(self, agent_id: str, delta: float, min_reputation: float, max_reputation: float) -> None:
        """
    ...
    async def run_consensus(self, consensus_id: str, agents: List[str], decision_func: callable, timeout: float) -> Optional[ConsensusResult]:
        """
    ...
    async def _collect_agent_vote(self, consensus_id: str, agent_id: str, decision_func: callable) -> None:
        """
