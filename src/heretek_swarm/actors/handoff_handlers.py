...
class HandoffValidationHandler:
    ...
    async def validate(self, from_agent_id: str, to_agent_id: str, context: Dict[str, Any]) -> Tuple[bool, Optional[str]]:
...
class HandoffRateLimitHandler:
    ...
    def __init__(self, handoff_timestamps: List[Any], max_per_minute: int):
...
class HandoffTransferHandler:
    ...
    async def transfer_context(self, handoff_id: str, from_agent_id: str, to_agent_id: str, context: Dict[str, Any], reason: str, timestamp: str) -> Tuple[bool, Optional[str]]:
...
class HandoffLoggingHandler:
    ...
    def __init__(self, historian: Optional[Any]):
        self._historian = historian

    async def log_handoff(self, handoff_id: str, from_agent_id: str, to_agent_id: str, reason: str, timestamp: str, context: Dict[str, Any]) -> None:
...
class HandoffProcessor:
    ...
    def __init__(self, validator: Any, handoff_timestamps: List[Any], supervisor_getter: Any, actor_message_class: Any, historian: Optional[Any], max_active_handoffs: int):
    ...
    async def process(self, from_agent_id: str, to_agent_id: str, context: Dict[str, Any], reason: str, active_handoffs_count: int) -> HandoffResult:
