...
class BehaviorProfile:
    ...
    def is_within_normal_bounds(self, metrics: BehaviorMetrics, std_threshold: float) -> Tuple[bool, List[str]]:
        """
...
class AnomalyDetector:
    ...
    def detect_anomalies(self, agent_id: str, metrics: BehaviorMetrics, profile: Optional[BehaviorProfile]) -> List[Anomaly]:
        """
...
class BehaviorProfiler:
    ...
    def __init__(self, config: Optional[ProfilingConfig]):
    ...
    def record_activity(self, agent_id: str, action: ActionType, metadata: Optional[Dict[str, Any]], duration_ms: float, success: bool) -> None:
        """
    ...
    def update_profile(self, agent_type: str, agent_id: str) -> Optional[BehaviorProfile]:
        """
    ...
    def get_alerts(self, agent_id: Optional[str], severity: Optional[AlertSeverity], unacknowledged_only: bool) -> List[Alert]:
        """
...
def initialize_profiler(config: Optional[ProfilingConfig]) -> BehaviorProfiler:
