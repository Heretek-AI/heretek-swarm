...
class HistorianAgent(AgentActor):
    ...
    async def unified_query(self, _query: str, _sources: Optional[List[str]], _limit: int, _rerank: bool, _diversity_lambda: float, _filters: Optional[Dict[str, Any]]) -> KnowledgeQueryResult:
        """
    ...
    async def store_memory(self, _content: Dict[str, Any], _metadata: Optional[Dict[str, Any]], _ttl: Optional[int], _persistent: bool, _lineage: Optional[List[str]]) -> MemoryEntry:
        """
        Store a memory.
    ...
    async def retrieve_context(self, _topic: str, _filters: Optional[Dict[str, Any]], _window_size: int) -> List[Dict[str, Any]]:
        """
    ...
    async def query_history(self, _query_text: Optional[str], _filters: Optional[Dict[str, Any]], _limit: int) -> List[Dict[str, Any]]:
        """
    ...
    def _compute_similarity(self, _text1: str, _text2: str) -> float:
        ...
        def cosine_similarity(_vec1: Dict[str, int], _vec2: Dict[str, int]) -> float:
