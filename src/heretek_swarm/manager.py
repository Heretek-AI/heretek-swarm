...
class Plugin:
    ...
    async def on_message(self, _message: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        """
...
class PluginRuntime:
    ...
    async def execute_plugin(self, _plugin_name: str, _method: str, **kwargs) -> Any:
        """
    ...
    async def broadcast_message(self, _message: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
