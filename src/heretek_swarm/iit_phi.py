...
class PhiCalculator:
    ...
    def _validate_cause_effect_structure(self, structure: Dict[str, Any]) -> ValidationResult:
        """
    ...
    def _calculate_element_cause_effect(self, element: str, elements: List[str], connectivity: Dict[str, Dict[str, float]], current_state: Dict[str, Any], transition_probabilities: Optional[Dict[str, Any]]) -> CauseEffectStructure:
        """
    ...
    def _calculate_cause_repertoire(self, element: str, elements: List[str], connectivity: Dict[str, Dict[str, float]], current_state: Dict[str, Any]) -> Dict[str, float]:
        """
    ...
    def _calculate_effect_repertoire(self, element: str, elements: List[str], connectivity: Dict[str, Dict[str, float]], current_state: Dict[str, Any], transition_probabilities: Optional[Dict[str, Any]]) -> Dict[str, float]:
        """
    ...
    def _calculate_partition_loss(self, part1: Set[str], part2: Set[str], connectivity: Dict[str, Dict[str, float]]) -> float:
        """
    ...
    def _determine_integration_level(self, connectivity: Dict[str, Dict[str, float]], elements: List[str]) -> str:
        """
    ...
    def _determine_differentiation_level(self, current_state: Dict[str, Any], elements: List[str]) -> str:
        """
