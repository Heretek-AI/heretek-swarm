...
class MemoryManager:
    ...
    def __init__(self, config: Optional[MemoryManagerConfig], agent_id: str) -> None:
        """
    ...
    async def remember(self, content: str, agent_id: Optional[str], importance: float, decay_rate: Optional[float], memory_type: Optional[str], tags: Optional[list[str]], metadata: Optional[dict[str, Any]]) -> ElizaMemoryEntry:
        """
    ...
    async def recall(self, query: Optional[str], agent_id: Optional[str], limit: Optional[int], min_importance: float) -> list[ElizaMemoryEntry]:
        """
    ...
    async def get_working_context(self, agent_id: Optional[str], limit: int) -> list[ElizaMemoryEntry]:
        """
...
async def create_memory_manager(agent_id: str, use_mem0: bool) -> MemoryManager:
    """
