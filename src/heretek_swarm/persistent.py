...
class PersistentMemory:
    ...
    def __init__(self, config: Optional[Mem0Config], user_id: str) -> None:
        """
    ...
    async def store(self, content: str, user_id: Optional[str], agent_id: Optional[str], metadata: Optional[dict[str, Any]]) -> str:
        """
    ...
    async def store_batch(self, memories: list[dict[str, Any]], user_id: Optional[str]) -> list[str]:
        """
    ...
    async def search(self, query: str, user_id: Optional[str], agent_id: Optional[str], limit: int) -> list[dict[str, Any]]:
        """
    ...
    async def get_all(self, user_id: Optional[str], limit: int) -> list[dict[str, Any]]:
        """
    ...
    async def update(self, memory_id: str, content: Optional[str], metadata: Optional[dict[str, Any]]) -> bool:
        """
...
async def create_memory_store(provider: str, user_id: str) -> PersistentMemory:
    """
