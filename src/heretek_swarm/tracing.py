...
def create_span(_name: str, _attributes: Optional[Dict[str, Any]], _kind: trace.SpanKind) -> Callable:
    """
...
@contextmanager
def span_context(_name: str, _attributes: Optional[Dict[str, Any]], _kind: trace.SpanKind):
    """
...
def set_span_attributes(_attributes: Dict[str, Any]) -> None:
