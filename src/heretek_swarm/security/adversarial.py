...
class AdversarialDetector:
    ...
    def _compile_patterns(self, signatures: List[Tuple[str, str, AttackCategory, float]]) -> List[Tuple[re.Pattern, str, AttackCategory, float]]:
    ...
    def _detect_patterns(self, text: str, patterns: List[Tuple[re.Pattern, str, AttackCategory, float]]) -> List[DetectionMatch]:
