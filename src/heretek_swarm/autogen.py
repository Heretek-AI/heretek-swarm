...
autogen_adapter: Optional[AutoGenAdapter] = None
...
def create_assistant_agent(agent_id: str, name: str, system_message: str, llm_config: Optional[Dict[str, Any]], tools: Optional[List[Callable]]) -> Any:
    """
