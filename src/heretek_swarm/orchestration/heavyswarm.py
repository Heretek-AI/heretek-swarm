...
class HeavySwarmWorkflow:
    ...
    async def execute(self, _topic: str, _context: Optional[Dict[str, Any]], _workflow_id: Optional[str]) -> WorkflowResult:
        """
    ...
    async def _execute_phase(self, _workflow_id: str, _phase: WorkflowPhase, _phase_func: Callable, *args: Any, **kwargs: Any) -> PhaseResult:
        """
    ...
    async def _research_phase(self, _workflow_id: str, _topic: str, _context: Optional[Dict[str, Any]]) -> Dict[str, Any]:
        """
    ...
    async def _analysis_phase(self, _workflow_id: str, _topic: str, _context: Optional[Dict[str, Any]], _research_data: Optional[Dict[str, Any]]) -> Dict[str, Any]:
        """
    ...
    async def _collect_triad_analyses(self, _workflow_id: str, _topic: str, _research_data: Dict[str, Any], _analysis_type: str) -> Dict[str, Dict[str, Any]]:
        """
    ...
    async def _alternatives_phase(self, _workflow_id: str, _topic: str, _context: Optional[Dict[str, Any]], _analysis_data: Optional[Dict[str, Any]]) -> Dict[str, Any]:
        """
    ...
    async def _generate_alternatives(self, _topic: str, _analysis_data: Dict[str, Any]) -> List[Dict[str, Any]]:
    ...
    async def _evaluate_alternative(self, _alternative: Dict[str, Any], _analysis_data: Dict[str, Any]) -> Dict[str, Any]:
    ...
    async def _identify_trade_offs(self, _alternatives: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
    ...
    async def _verification_phase(self, _workflow_id: str, _topic: str, _context: Optional[Dict[str, Any]], _alternatives_data: Optional[Dict[str, Any]]) -> Dict[str, Any]:
        """
    ...
    async def _decision_phase(self, _workflow_id: str, _topic: str, _context: Optional[Dict[str, Any]], _verification_data: Optional[Dict[str, Any]]) -> Dict[str, Any]:
        """
    ...
    async def _collect_triad_votes(self, _consensus_id: str, _topic: str, _verification_data: Dict[str, Any]) -> List[Dict[str, Any]]:
        """
