...
class DecisionAudit:
    ...
    def update_outcome(self, outcome: DecisionOutcome, verified: bool) -> None:
        """
...
class ConsensusAuditTrail:
    ...
    def __init__(self, storage_backend: str, retention_days: int, enable_hash_chain: bool) -> None:
        """
    ...
    def record_event(self, event_type: AuditEventType, consensus_id: str, agent_id: Optional[str], data: Optional[Dict[str, Any]]) -> AuditEvent:
        """
    ...
    def record_decision(self, decision_id: str, consensus_id: str, proposal: str, decision: str, confidence: float, participants: Optional[List[str]], reasoning: Optional[str], metadata: Optional[Dict[str, Any]]) -> DecisionRecord:
        """
    ...
    def record_vote(self, consensus_id: str, agent_id: str, decision: str, confidence: float, reasoning: Optional[str], metadata: Optional[Dict[str, Any]]) -> VoteRecord:
        """
    ...
    def record_argument(self, consensus_id: str, agent_id: str, position: str, content: str, supports: Optional[List[str]], rebuttals: Optional[List[str]]) -> ArgumentRecord:
        """
    ...
    def record_decision_outcome(self, decision_id: str, outcome: DecisionOutcome, outcome_data: Optional[Dict[str, Any]]) -> None:
        """
    ...
    def record_rollback(self, decision_id: str, reason: str) -> None:
        """
    ...
    def create_decision_audit(self, decision_id: str, consensus_id: str, final_decision: str, consensus_method: str, confidence_score: float, confidence_breakdown: Optional[Dict[str, float]], dissenting_agents: Optional[List[str]], minority_report: Optional[str], metadata: Optional[Dict[str, Any]]) -> DecisionAudit:
        """
    ...
    def record_deliberation_round(self, consensus_id: str, round_number: int, arguments_submitted: Optional[List[str]], positions: Optional[Dict[str, str]], consensus_score: float) -> DeliberationRoundRecord:
        """
    ...
    def export_decision_audit(self, decision_id: str, format: str) -> str:
        """
    ...
    def export_all_audits(self, format: str) -> str:
        """
    ...
    def get_arguments_for_consensus(self, consensus_id: str) -> List[ArgumentRecord]:
        """
    ...
    def query_decisions(self, start_date: Optional[str], end_date: Optional[str], consensus_type: Optional[str], min_confidence: Optional[float], outcome: Optional[DecisionOutcome], participants: Optional[List[str]]) -> QueryResult:
        """
    ...
    def export_audit_data(self, format: str, consensus_id: Optional[str], include_events: bool, include_votes: bool, include_arguments: bool) -> Dict[str, Any]:
        """
    ...
    def cleanup_old_data(self, current_date: Optional[datetime]) -> int:
        """
