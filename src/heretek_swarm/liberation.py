...
class LiberationShield:
    ...
    def __init__(self, mode: str, state_path: Optional[str], enable_prompt_injection_detection: bool, enable_jailbreak_detection: bool, enable_anomaly_detection: bool, enable_audit_logging: bool, max_log_entries: int) -> None:
        """
    ...
    async def analyze_input(self, input_text: str, context: Optional[Dict[str, Any]]) -> ThreatAnalysis:
        """
    ...
    async def validate_output(self, output_text: str, context: Optional[Dict[str, Any]]) -> ThreatAnalysis:
        """
    ...
    async def check_anomaly(self, operation: Dict[str, Any], context: Optional[Dict[str, Any]]) -> AnomalyResult:
        """
    ...
    def _log_event(self, event_type: SecurityEventType, data: Dict[str, Any], context: Dict[str, Any]) -> None:
        """
    ...
    def get_audit_trail(self, filters: Optional[Dict[str, Any]]) -> List[Dict[str, Any]]:
        """
...
class LiberationPlugin:
    ...
    def __init__(self, shield_mode: str, enable_input_scanning: bool, enable_output_scanning: bool, enable_anomaly_detection: bool, audit_enabled: bool) -> None:
        """
    ...
    async def scan_input(self, input_text: str, agent_id: str, context: Optional[Dict[str, Any]]) -> ThreatAnalysis:
        """
    ...
    async def scan_output(self, output_text: str, agent_id: str, context: Optional[Dict[str, Any]]) -> ThreatAnalysis:
        """
    ...
    async def check_operation_anomaly(self, operation: Dict[str, Any], agent_id: str, context: Optional[Dict[str, Any]]) -> AnomalyResult:
        """
    ...
    def get_audit_trail(self, agent_id: Optional[str], limit: int) -> List[Dict[str, Any]]:
        """
        Get audit trail.
