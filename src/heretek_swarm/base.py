...
class MemorySystem(ABC):
    ...
    @abstractmethod
    async def store(self, content: Dict[str, Any], metadata: Optional[Dict[str, Any]], ttl: Optional[int], lineage: Optional[List[str]]) -> MemoryEntry:
        """
...
class PersistentMemory(MemorySystem):
    ...
    async def store(self, content: Dict[str, Any], metadata: Optional[Dict[str, Any]], _ttl: Optional[int], lineage: Optional[List[str]]) -> MemoryEntry:
...
class DualTierMemory:
    ...
    def __init__(self, ephemeral: Optional[EphemeralMemory], persistent: Optional[PersistentMemory]) -> None:
        """
    ...
    async def store(self, content: Dict[str, Any], metadata: Optional[Dict[str, Any]], ttl: Optional[int], lineage: Optional[List[str]], persistent: bool) -> MemoryEntry:
        """
    ...
    async def query(self, query_text: Optional[str], filters: Optional[Dict[str, Any]], limit: int, include_persistent: bool) -> List[MemoryEntry]:
        """
