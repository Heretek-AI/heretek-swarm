...
_logger = structlog.get_logger("AgentRegistry")
    ...
    def load_all(self) -> None:
        ...
        for char_file in self.characters_dir.glob("*.json"):
            try:
                ...
                _topics = self._generate_topics(name, role, capabilities)
