...
class ReasoningChain:
    ...
    def add_step(self, step_type: str, content: str, confidence: float, sources: Optional[List[str]]) -> ReasoningStep:
...
class EnhancedMAKERConsensus(MAKERConsensus):
    ...
    def __init__(self, ahead_by_k: int, min_votes: int, confidence_threshold: float, reputation_weights: Optional[Dict[str, float]], enable_pattern_library: bool, enable_rollback: bool, enable_cross_validation: bool, expertise_profiler: Optional[AgentExpertiseProfiler], max_reasoning_depth: int) -> None:
        """
    ...
    def start_consensus(self, consensus_id: str, proposal: Optional[str], domain: Optional[str]) -> None:
        """
    ...
    def add_vote(self, consensus_id: str, agent_id: str, decision: str, confidence: float, metadata: Optional[Dict[str, Any]]) -> None:
        """
    ...
    def add_vote_with_reasoning(self, consensus_id: str, agent_id: str, decision: str, confidence: float, reasoning_chain: List[Dict[str, Any]], pattern_references: Optional[List[str]], metadata: Optional[Dict[str, Any]]) -> Optional[str]:
        """
    ...
    def calculate_vote_weight(self, consensus_id: str, enhanced_vote: EnhancedVote, domain: Optional[str]) -> float:
        """
    ...
    def _apply_enhanced_vote_weights(self, votes: List[Vote], consensus_id: str) -> List[Tuple[str, float]]:
        """
    ...
    def _calculate_expertise_score(self, agent_id: str, domain: Optional[str]) -> float:
        """
    ...
    def record_decision_outcome(self, consensus_id: str, agent_id: str, was_correct: bool) -> None:
        """
    ...
    def compute_consensus(self, consensus_id: str) -> Optional[ConsensusResult]:
        """
    ...
    def compute_consensus_with_validation(self, consensus_id: str, min_validation_score: float) -> Optional[ConsensusResult]:
        """
    ...
    def _cross_validate_reasoning(self, consensus_id: str) -> Dict[str, Any]:
        """
    ...
    def _get_validation_results(self, consensus_id: str) -> Dict[str, Any]:
        """
    ...
    def get_decision_provenance(self, consensus_id: str) -> Optional[DecisionProvenance]:
        """
    ...
    def get_reasoning_chains(self, consensus_id: str) -> List[ReasoningChain]:
        """
    ...
    def rollback_decision(self, consensus_id: str, reason: Optional[str]) -> RollbackResult:
        """
    ...
    def export_provenance(self, consensus_id: str) -> Optional[Dict[str, Any]]:
        """
    ...
    def generate_decision_hash(self, consensus_id: str) -> Optional[str]:
        """
