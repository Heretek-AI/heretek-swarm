...
class GlobalWorkspace:
    ...
    def __init__(self, max_capacity: int, competition_threshold: float) -> None:
        """
    ...
    def submit(self, content: Dict[str, Any], source: str, priority: float, ttl: int) -> str:
        """
    ...
    def get_contents(self, min_priority: float, limit: int) -> List[GlobalWorkspaceItem]:
        """
...
class AttentionSchemaManager:
    ...
    def create_schema(self, agent_id: str, focus_target: Optional[str]) -> AttentionSchema:
        """
    ...
    def update_attention(self, agent_id: str, focus_target: str, intensity: float) -> Optional[AttentionSchema]:
        """
...
class ConsciousnessPlugin:
    ...
    def __init__(self, gwt_threshold: float, iit_phi_threshold: float, ast_threshold: float) -> None:
        """
    ...
    def submit_to_workspace(self, source: str, content: Dict[str, Any], priority: float, ttl: int) -> str:
        """
        Submit content to the global workspace.
    ...
    def get_workspace_contents(self, min_priority: float, limit: int) -> List[Dict[str, Any]]:
        """Get current workspace contents."""
    ...
    def update_agent_attention(self, agent_id: str, focus_target: str, intensity: float) -> Optional[Dict[str, Any]]:
        """
        Update an agent's attention state.
    ...
    def calculate_consciousness_metrics(self, agent_id: str, gwt_score: Optional[float], iit_phi: Optional[float], ast_competence: Optional[float], fep_score: Optional[float]) -> ConsciousnessMetrics:
        """
    ...
    def _determine_consciousness_state(self, gwt_score: float, iit_phi: float, ast_competence: float, fep_score: Optional[float]) -> ConsciousnessState:
        """
