...
def create_workflow_graph(graph_id: str, nodes: List[Dict[str, Any]], edges: List[Dict[str, Any]], entry_point: str, state_schema: Optional[Dict[str, Any]]) -> LangGraphAdapter:
    """
