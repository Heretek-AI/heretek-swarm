...
class PhaseHandler(ABC):
    ...
    @abstractmethod
    async def execute(self, workflow_id: str, topic: str, context: Optional[Dict[str, Any]], previous_output: Optional[Dict[str, Any]]) -> Tuple[bool, Dict[str, Any], List[str]]:
        """
...
class ResearchPhaseHandler(PhaseHandler):
    ...
    async def execute(self, workflow_id: str, topic: str, context: Optional[Dict[str, Any]], _previous_output: Optional[Dict[str, Any]]) -> Tuple[bool, Dict[str, Any], List[str]]:
        ...
        logger.info(f"Research phase complete", extra={
...
class AnalysisPhaseHandler(PhaseHandler):
    ...
    async def execute(self, workflow_id: str, topic: str, _context: Optional[Dict[str, Any]], previous_output: Optional[Dict[str, Any]]) -> Tuple[bool, Dict[str, Any], List[str]]:
...
class AlternativesPhaseHandler(PhaseHandler):
    ...
    async def execute(self, _workflow_id: str, topic: str, _context: Optional[Dict[str, Any]], previous_output: Optional[Dict[str, Any]]) -> Tuple[bool, Dict[str, Any], List[str]]:
