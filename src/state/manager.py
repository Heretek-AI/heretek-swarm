...
class StateManager:
    ...
    def __init__(self, config: StateConfig | None = None):
        ...
        self._system: SystemState | None = None
    ...
    async def initialize(self, initial_system_state: SystemState | None = None) -> None:
    ...
    async def _restore_from_snapshot(self, snapshot: StateSnapshot) -> None:
        ...
        # Restore lineage
        self.lineage._nodes = {}
        for lineage_dict in snapshot.message_lineage.values():
    ...
    async def get_agent_conversations(
        ...
        for conv_id in conv_ids:
            ...
            if conv and (not active_only or conv.status == StateStatus.ACTIVE):
