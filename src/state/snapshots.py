...
class SnapshotManager:
    ...
    async def create_snapshot(self, _system_state: Optional[SystemState], _agent_states: Optional[Dict[str, AgentState]], _conversation_states: Optional[Dict[str, ConversationState]], _message_lineage: Optional[Dict[str, Any]], _scope: str, _scope_ids: Optional[List[str]], _trigger: str, _description: Optional[str], _snapshot_type: str) -> StateSnapshot:
        """
