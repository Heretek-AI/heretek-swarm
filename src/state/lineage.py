...
class LineageTracker:
    ...
    async def record_message(self, _content: Any, _conversation_id: UUID, _sender_agent_id: str, _receiver_agent_id: Optional[str], _message_type: MessageType, _parent_message_id: Optional[UUID], _correlation_id: Optional[UUID], _tags: Optional[List[str]], _metadata: Optional[Dict[str, Any]]) -> MessageLineage:
        """
